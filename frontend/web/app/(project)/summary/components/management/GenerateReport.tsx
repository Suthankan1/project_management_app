...
export function GenerateReport({ projectId, isAgile }: { projectId: number | string, isAgile: boolean }) {
  return (
    <div className="h-full w-full">
      <div className="h-full bg-gradient-to-r from-[#0052CC] via-[#1A6FE0] to-[#2684FF] rounded-xl border border-blue-400/40 p-4 shadow-lg text-white relative overflow-hidden group">
        ...
        <div className="relative z-10 flex flex-row items-center justify-between gap-4 h-full">
          ...
          <Link
            ...
            className="flex items-center justify-center gap-2 px-5 py-2.5 rounded-xl font-bold text-[13px] transition-all bg-white text-[#0052CC] hover:bg-blue-50 shadow-sm whitespace-nowrap"
          >
            <ArrowRight size={15} />
            View Report
          </Link>
