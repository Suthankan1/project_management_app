      ...
      {recentPages.length === 0 ? (
        ...
        <div className="space-y-3">
          {recentPages.map(page => (
            <Link key={page.id} href={`/pages/${page.id}?projectId=${projectId}`} className="flex items-center gap-2 p-2 hover:bg-cu-hover rounded-lg border border-transparent hover:border-cu-border transition-all group">
