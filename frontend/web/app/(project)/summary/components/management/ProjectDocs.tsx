      ...
      {recentPages.length === 0 ? (
        ...
        <div className="space-y-3">
          {recentPages.map(page => (
            <Link key={page.id} href={`/project/${projectId}/pages/${page.id}`} className="flex items-center gap-2 p-2 hover:bg-gray-50 rounded-lg border border-transparent hover:border-gray-200 transition-all group">
