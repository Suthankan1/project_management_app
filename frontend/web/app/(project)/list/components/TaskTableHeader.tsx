export default function TaskTableHeader() {
  return (
    <div className="hidden md:flex items-center gap-2 px-4 py-2 bg-cu-bg-secondary border-b border-cu-border text-[11px] font-semibold text-cu-text-secondary uppercase tracking-wide sticky top-0 z-10">
