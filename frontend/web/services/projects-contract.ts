...
import type { CreateProjectRequest } from '@planora/contracts';
...
export const projectsApi = {
  ...
  create: async (payload: CreateProjectRequest): Promise<ProjectSummary> => {
    const { data } = await createProjectBuilder(api, payload);
    return data;
  },
