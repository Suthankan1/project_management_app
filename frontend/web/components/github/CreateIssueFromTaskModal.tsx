      ...
      >
        <div className="flex items-center justify-between border-b border-slate-100 px-5 py-4">
          <div className="flex items-center gap-2.5">
            ...
            <div>
              <h3 className="text-base font-outfit font-bold text-slate-800">Create GitHub Issue</h3>
              <p className="text-xs font-outfit text-slate-400">Create a GitHub issue from this task</p>
            </div>
          </div>
          <button
            type="button"
        ...
        <div className="space-y-4 px-5 py-5">
          <div className="rounded-2xl border border-slate-200 bg-slate-50 p-4 shadow-sm">
            <p className="text-xs font-outfit font-bold uppercase tracking-wide text-slate-400">Repository</p>
            <p className="mt-1 text-sm font-outfit font-semibold text-slate-800">{repoFullName}</p>
          </div>

          <div className="space-y-2">
            <label className="text-xs font-outfit font-bold uppercase tracking-wide text-slate-400">Issue title</label>
            <input
              type="text"
              value={title}
              onChange={(event) => setTitle(event.target.value)}
              className="w-full rounded-xl border border-slate-200 bg-white px-4 py-3 text-sm font-outfit text-slate-800 outline-none transition-colors focus:border-slate-400"
          ...
          <div className="space-y-2">
            <label className="text-xs font-outfit font-bold uppercase tracking-wide text-slate-400">Body</label>
            <textarea
              value={body}
          ...
          <div className="space-y-2">
            <label className="text-xs font-outfit font-bold uppercase tracking-wide text-slate-400">Labels</label>
            <div className="rounded-xl border border-slate-200 bg-white px-3 py-2">
              <div className="flex flex-wrap gap-2">
                {labels.map((label) => (
                  <span
                    key={label}
                    className="inline-flex items-center gap-1 rounded-full border border-slate-200 bg-slate-50 px-2.5 py-1 text-xs font-outfit font-semibold text-slate-700"
                  >
                    {label}
                    <button
                      type="button"
                ...
                <input
                  ...
                  className="min-w-[160px] flex-1 border-0 bg-transparent px-1 py-1 text-sm font-outfit text-slate-800 outline-none"
                />
              </div>
            </div>
            <p className="text-xs font-outfit text-slate-400">Press Enter or comma to add a label.</p>
          </div>
          ...
          <div className="flex items-center justify-end gap-3 border-t border-slate-100 pt-4">
            ...
            <button
              ...
              className="inline-flex items-center justify-center gap-2 rounded-xl border border-slate-900 bg-slate-900 px-4 py-2.5 text-sm font-outfit font-semibold text-white shadow-sm transition-colors hover:bg-slate-800 disabled:cursor-not-allowed disabled:opacity-60"
            >
