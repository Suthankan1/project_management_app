...
-- Stores the link between a Planora project and a GitHub repository
...
CREATE INDEX idx_github_prs_integration  ON github_pull_requests(integration_id);
CREATE INDEX idx_github_prs_state        ON github_pull_requests(state);
CREATE INDEX idx_github_commits_integ    ON github_commits(integration_id);
CREATE INDEX idx_github_issues_integ     ON github_issues(integration_id);
